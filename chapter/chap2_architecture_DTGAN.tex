...
DTGAN sử dụng một hệ thống hàm mất mát đa thành phần phức tạp, phản ánh mục tiêu kép của hai nhánh decoder. Hình~\ref{fig:loss_diagram} minh họa toàn bộ pipeline. Mỗi hàm mất mát dưới đây được trình bày theo format thống nhất: \textbf{Tên} $\to$ \textbf{Ý nghĩa/Tác dụng} $\to$ \textbf{Công thức} $\to$ \textbf{Giải thích}.
