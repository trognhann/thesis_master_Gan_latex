...
\begin{enumerate}
    ...
    \item \textbf{Chi phí tính toán Hybrid Mode:} Thời gian xử lý Hybrid Mode tăng tuyến tính theo số khuôn mặt ($1 + N$ lần suy luận ONNX), có thể chậm với ảnh nhóm đông ($N > 5$).
