...
Dữ liệu phong cách anime được trích xuất từ phim hoạt hình của các đạo diễn nổi tiếng, bao gồm hai tập chính:
\begin{itemize}
    \item \textbf{Hayao Miyazaki:} Các frame từ phim \textit{Spirited Away}, \textit{My Neighbor Totoro} — phong cách warm, giàu màu sắc tự nhiên, đường nét mềm mại. % TODO: Bổ sung số lượng ảnh cụ thể
    \item \textbf{Makoto Shinkai:} Các frame từ \textit{Your Name}, \textit{Weathering With You} — phong cách lạnh, ánh sáng cinematic, chi tiết mịn. % TODO: Bổ sung số lượng ảnh cụ thể
\end{itemize}
...
\end{figure}
    \noindent\textit{Chú thích:} (a) Hybrid Mode xử lý tất cả khuôn mặt phát hiện được ở chất lượng $512 \times 512$ rồi ghép lại nền Landscape -- phù hợp nhất cho ảnh nhóm. (b) Landscape Mode bảo toàn bố cục nhưng chi tiết khuôn mặt bị mất (c). (d) Face Mode chỉ xử lý khuôn mặt lớn nhất, bỏ qua các mặt khác và nền.
...
\hline
FID ($512\times512$) & 64.2 & 58.6 & 60.1 \\
\hline
\end{tabular}
\end{table}
...
\hline
FPS ($512^2$, GPU) & 18 & $\sim$1.5 & $\sim$0.5 & 12--36$\times$ \\
\hline
