...
\draw (0,-24.2) node[above]{\fontsize{12}{12}\selectfont{\textbf{HÀ NỘI - 2023}}};
\end{tikzpicture}
\end{center}
\vspace{-1.5cm}
	\begin{center}
...
\vspace{4cm}
	...
	{\textbf {\fontsize{14}{14}\selectfont{NGUYỄN TRỌNG NHÂN}}}\\
	\vspace{1.5cm}
...
{
{\textbf {\MakeUppercase{\fontsize{17}{17}\selectfont{NGHIÊN CỨU ỨNG DỤNG CÔNG NGHỆ DẬP THỦY LỰC KHÔNG SỬ DỤNG CỐI }}}}\\[3pt]
{\textbf {\MakeUppercase{\fontsize{17}{17}\selectfont{ĐỂ CHẾ TẠO CHI TIẾT DẠNG HÌNH CẦU}}}}\\[3pt]
{\textbf {\MakeUppercase{\fontsize{17}{18}\selectfont{(MÔ PHỎNG VÀ CHẾ TẠO)}}}}\\
}

\vspace{3cm}
\MakeUppercase{\textbf{\fontsize{14}{14}\selectfont{{KHÓA LUẬN TỐT NGHIỆP ĐẠI HỌC HỆ CHÍNH QUY}}}}\\[3pt]
{\fontsize{14}{14}\textbf{\selectfont{Ngành: Công nghệ kỹ thuật cơ điện tử}}}

\end{center}
\vspace{1.5cm}
		\begin{tabularx}
				{\linewidth}{>{\setlength\hsize{.0\hsize}}X>{\setlength\hsize{0.8\hsize}}X}
										& \fontsize{14}{14}\textbf{\selectfont{Cán bộ hướng dẫn: TS. Đinh Văn Duy}}
