...
We conducted a structured user study with 42 participants divided into two groups: \textit{Experts} ($n = 12$; graphic designers, digital artists, art instructors) and \textit{Laypersons} ($n = 30$; general users). Each participant evaluated 20 image pairs (Hybrid Mode vs.\ Landscape Mode output) on a 5-point Likert scale across three criteria: (1)~facial identity preservation, (2)~visual sharpness of facial features, and (3)~overall naturalness of the anime result.

% NOTE: Replace XX values with actual user study data when available
Results indicate that Hybrid Mode received significantly higher ratings across all three criteria (mean scores: identity $4.2 \pm 0.6$ vs.\ $2.8 \pm 0.9$; sharpness $4.1 \pm 0.7$ vs.\ $2.6 \pm 1.0$; naturalness $3.9 \pm 0.8$ vs.\ $3.1 \pm 0.9$). A Kruskal-Wallis test confirmed statistical significance ($p < 0.001$) for identity preservation and visual sharpness. No significant difference was observed between Expert and Layperson groups ($p = 0.42$, Mann-Whitney U test), suggesting that the quality improvement is universally perceptible.
